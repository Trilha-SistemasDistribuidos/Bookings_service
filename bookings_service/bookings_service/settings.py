"""
Django settings for bookings_service project.
...
SECRET_KEY = 'django-insecure-5lh+dx^)(zy@h7-z2=0rysawg7@p#da6n72cc5i3emo412z!xm'
...
TRAILS_SERVICE_URL = 'http://localhost:8002'  # URL do trails_service
USERS_SERVICE_URL = 'http://localhost:8001'  # URL do users_service
USERS_SERVICE_TOKEN = 'seu_token_secreto_aqui'  # Token fixo para serviços
